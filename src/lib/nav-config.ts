...
export const allMenuItems: MenuItem[] = [
  ...
  { id: 'appointments', href: "/appointments", label: "Book Appointments", telugu: "నమోదులు", icon: CalendarCheck, color: "hsl(var(--nav-appointments))", defaultVisible: true, customizable: false },
  ...
  { id: 'language', href: '#', label: 'Language', telugu: 'భాష', icon: Globe, color: 'hsl(var(--nav-profile))', defaultVisible: false, customizable: true },
