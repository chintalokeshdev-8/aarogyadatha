...
export const allMenuItems: MenuItem[] = [
  ...
  { id: 'communityFund', href: "/community-fund", label: "Community Fund", telugu: "సంఘ నిధి", icon: HandHeart, color: "hsl(var(--nav-blood-bank))", defaultVisible: false, customizable: true },
