  ...
  return (
    <>
      {isMobile ? (
        ...
        <Button
          variant="outline"
          className="relative h-10 w-full max-w-xl justify-start rounded-full bg-primary-foreground/10 border-primary-foreground/30 text-sm text-primary-foreground/70 placeholder:text-primary-foreground/70 hover:bg-primary-foreground/20 hover:text-primary-foreground"
          onClick={() => setOpen(true)}
        >
